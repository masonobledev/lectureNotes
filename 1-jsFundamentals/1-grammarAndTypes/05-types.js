...
/*
Null and undefined both represent variables with no value inside.  Think of it this way: null vlaues are for gag 
gifts that are boxes intentionally given with nothing inside (because that's the gag).  Undefined values are gifts
given when the person giving the gift has forgotten to put the gift inside (oops!).
*/
...
key-value pair is separated with a coma.
*/
